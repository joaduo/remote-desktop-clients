...
public class Database extends SQLiteOpenHelper {
    ...
    static final int DBVNT_1_0_0 = 10001;
    static final int CURRVERS = DBVNT_1_0_0;
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion == DBV_2_1_7) {
            Log.i(TAG,"Doing upgrade from 501 to 10001");
            db.execSQL("ALTER TABLE " + AbstractConnectionBean.GEN_TABLE_NAME + " ADD COLUMN "
                    +AbstractConnectionBean.GEN_FIELD_NT_ADDRESS+ " TEXT");
            db.execSQL("ALTER TABLE " + AbstractConnectionBean.GEN_TABLE_NAME + " ADD COLUMN "
                    +AbstractConnectionBean.GEN_FIELD_NT_PORT + " INTEGER");
            oldVersion = DBVNT_1_0_0;
        }
    }
}

...
public abstract class AbstractConnectionBean extends com.antlersoft.android.dbimpl.IdImplementationBase implements IConnectionBean {
    ...
    public static final int GEN_ID_NT_ADDRESS = 81;
    public static final String GEN_FIELD_NT_PORT = "NT_PORT";
    public static final int GEN_ID_NT_PORT = 82;
    ...
    public int[] Gen_columnIndices(android.database.Cursor cursor) {
        ...
        result[81] = cursor.getColumnIndex(GEN_FIELD_NT_ADDRESS);
        result[82] = cursor.getColumnIndex(GEN_FIELD_NT_PORT);
